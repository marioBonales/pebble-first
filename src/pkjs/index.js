...
function locationSuccess(pos) {
  var url = `https://api.open-meteo.com/v1/forecast?latitude=${pos.coords.latitude}&longitude=${pos.coords.longitude}&current=temperature_2m,weather_code`;
  ...
  xhrRequest(url, 'GET', function(response) {
    ...
    Pebble.sendAppMessage(dictionary, function (e) { console.log('Success') }, function(e) { console.log('Failure') });
  })
}

function locationError(error) {
  console.log('Error when requesting location'. error);
}
